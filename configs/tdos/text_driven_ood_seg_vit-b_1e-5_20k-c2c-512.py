_base_ = [
    ...
    '../_base_/datasets/city2city-512.py']
...
model = dict(
    ...
    decode_head=dict(
        ...
        loss_cls=dict(
            ...
            loss_weight=2.0,
            reduction='mean',
            class_weight=[1.0] * 19 + [10.0] + [0.1]), # 일반 19개 , ood 1 개, 배경 1개 #$#$#$#$#$#$
        loss_mask=dict(
            type='CrossEntropyLoss',
            use_sigmoid=True,
            reduction='mean',
...
work_dir = './final_experiments_vit_b_freeze_prompt0'
