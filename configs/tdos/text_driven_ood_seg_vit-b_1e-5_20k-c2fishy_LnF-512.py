_base_ = [
    ...
    '../_base_/datasets/city2fishy_LnF.py']
...
# evaluation = dict(interval=50, metric='mIoU')  # 50 iter마다 평가 수행

work_dir = './work_dirs_d_clip_b_neg_label_guided_prompt_10'